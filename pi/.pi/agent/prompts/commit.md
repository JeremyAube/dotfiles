---
description: Create a concise Conventional Commits-style git commit
argument-hint: "[files] [guidance]"
---
Create a git commit for the current changes using a concise Conventional Commits-style subject.

Treat any caller-provided arguments as additional commit guidance: ${@:-none}

Common argument patterns:
- Freeform instructions should influence scope, summary, and body.
- File paths or globs should limit which files to commit. If files are specified, only stage/commit those unless I explicitly ask otherwise.
...
- If it is unclear whether a file should be included, ask me which files to commit.

## Steps

1. Infer from the arguments whether I provided specific file paths/globs and/or additional instructions.
